...
class Assignment(db.Model):
    ...
    def submit(cls, _id, teacher_id, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(assignment.student_id == auth_principal.student_id, 'assignment belongs to some other student')
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(assignment.teacher_id == auth_principal.teacher_id, 'assignment submitted to a different teacher cannot be graded')
